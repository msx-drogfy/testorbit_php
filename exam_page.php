          ...
          <div class="mb-npx">
            <div class="row align-items-center">
              <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                ...
                <?php
                            $ei = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM exams WHERE exam_key='$exam_key'")); 
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6 col-6 text-end">
                    <h5>Duration: <b><span id="timer"></span></h5>
              ...
              <script>
                // Set the time we're counting down to in minutes
                var minutes = <?php echo $duration; ?>; // Example: 10 minutes
                var hours = 0; // Initialize the hours variable

                // Calculate the total time in milliseconds
                var totalTimeInMilliseconds = minutes * 60000; // Convert minutes to milliseconds

                // Calculate the end time by adding the total time to the current time
                var countDownDate = new Date(Date.now() + totalTimeInMilliseconds);
                ...
                var x = setInterval(function() {
                  ...
                  var hours = Math.floor(distance / (1000 * 60 * 60)); // Calculate hours
          ...
          <div class="row g-6 mb-6">
            <div class="col-12">
              ...
              <form action="submit_exam.php" method="post">
                ...
                <?php
                $c = 0;
                $exam_questions = mysqli_query($conn, "SELECT * FROM exam_sets WHERE exam_key = '$exam_key' ORDER BY RAND()");
