                    ...
                    <div class="card shadow border-0 mb-4">
                        <div class="card-body">
                            ...
                            $ei = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM exams WHERE exam_key='$exam_key'")); ?>
                                ...
                                <p>Time <b><?php echo $ei['duration']; ?> minutes</b></p>
                                <br>
                                <a href="examiner.php?key=<?php echo $exam_key; ?>&group_key=<?php echo $gk; ?>" class="btn btn-sm btn-success mx-1" style="width: fit-content;">Start Exam</a>
