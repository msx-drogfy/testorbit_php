          ...
          <div class="row g-6 mb-6">
            <div class="col-12">
              ...
              <div class="card shadow border-0 mb-4">
                <div class="card-body">
                  <?php display_alert(); ?>
                  <form action="radio_marker.php" method="post">
                    ...
                    <div class="row">
                      ...
                      <ul>
                        <label for="option_<?php echo $qid; ?>_1">
                          <li class="ans" style="<?php if (isset($_GET['check'])) { if($_GET['select'] == 1) {if ($_GET['check'] == "pass"){echo "background-color: limegreen;";}else{echo "background-color: orangered;";}}} ?>">
                        ...
                        <label for="option_<?php echo $qid; ?>_2">
                          <li class="ans" style="<?php if (isset($_GET['check'])) { if($_GET['select'] == 2) {if ($_GET['check'] == "pass"){echo "background-color: limegreen;";}else{echo "background-color: orangered;";}}} ?>">
                        ...
                        <label for="option_<?php echo $qid; ?>_3">
                          <li class="ans" style="<?php if (isset($_GET['check'])) { if($_GET['select'] == 3) {if ($_GET['check'] == "pass"){echo "background-color: limegreen;";}else{echo "background-color: orangered;";}}} ?>">
                        ...
                        <label for="option_<?php echo $qid; ?>_4">
                          <li class="ans" style="<?php if (isset($_GET['check'])) { if($_GET['select'] == 4) {if ($_GET['check'] == "pass"){echo "background-color: limegreen;";}else{echo "background-color: orangered;";}}} ?>">
                            <input type="radio" id="option_<?php echo $qid; ?>_4" name="option_<?php echo $qid; ?>" value="4">
                            <?php echo $question['ans4']; ?>
                          </li>
                        </label>
                      </ul>
                      <?php if (!isset($_GET['check']) || $_GET['check'] == "fail") { ?>
