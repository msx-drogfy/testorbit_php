          ...
          <div class="row g-6 mb-6">
            <div class="col-12">
              ...
              <div class="card shadow border-0 mb-3">
                <div class="card-body">
                  ...
                  <h3>
                    ...
                    <?php
                    $user_exam_info = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM exam_registration WHERE exam_key = '$exam_key' AND user_id = '$user_id'"));
                    ?>
                  ...
                  <br>
                  <p>
                    Time Taken: <b><?php echo round(($user_exam_info['timeend'] - $user_exam_info['timestart']) / 60); ?> Minutes</b><br>
                    Score <b><?php echo $user_exam_info['score']; ?>/<?php echo $user_exam_info['questions']; ?></b><br>
                    Percentage <b><?php echo round(($user_exam_info['score'] / $user_exam_info['questions']) * 100); ?>%</b><br>
                  </p>
              ...
              while ($test = mysqli_fetch_array($exam_questions)) {
                ...
                $usx = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM question_answers WHERE user_id = '$user_id' AND exam_key = '$exam_key' AND question_id='$question[id]'"));
                $correct = str_replace(' ', '', $question['correct_ans']);
                if ($correct === $usx['chosen_answer']) {
                  $col = "success";
                } else {
                  $col = "danger";
                }
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <?php if ($question['check_radio'] == 'radio') { ?>
                        ...
                        <p id="option_<?php echo $question['id']; ?>_explanation" class="hidden mt-4"><?php echo $question['explanation']; ?>none</p>
