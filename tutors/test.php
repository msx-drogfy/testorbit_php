            ...
            <div class="col-12">
                  ...
                  <div class="row">
                    <div class="col">
                      <form action="exam_creator.php" method="post">
                        ...
                        <span class="h3 font-bold mb-0">Create & Take text exam
                        </span>
                        <label for="query">Enter the number of questions to be tested</label>
                        <select name="number_of_questions" id="numQuestions">
                          ...
                          <option value="50">Master's Challenge - 65 Questions</option>
                        </select>
                        <br>
                        <br>
              ...
              <div class="card shadow border-0 mb-4">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <span class="h3 font-bold mb-0">Join & Take test exam using link
                      </span>
